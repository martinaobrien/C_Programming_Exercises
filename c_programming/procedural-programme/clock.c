...
#include <window.h> //way of thinking about the programme - there is the data and the methods are sepereate
...
void printClock(structClock c) //exists outside the data method and the struct has to be passed into it
{
    printf("\n Clock");
